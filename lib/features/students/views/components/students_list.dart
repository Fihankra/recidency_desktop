...
class _StudentListState extends ConsumerState<StudentList> {
  ...
  Widget build(BuildContext context) {
    var studentsData = ref.watch(studentProvider);
    var studentReader = ref.read(studentProvider.notifier);
              ...
              Expanded(
                child: CustomTable<StudentModel>(
                  currentIndex: studentsData.currentPageItems.isEmpty
                      ? 0
                      : studentsData.items
                              .indexOf(studentsData.currentPageItems[0]) +
                          1,
                  lastIndex:
                        ...
                        return CircleAvatar(
                          ...
                          backgroundImage:
                              student.image != null && student.image!.isNotEmpty
                                  ? MemoryImage(base64Decode(student.image!))
                                  : null,
                        );
                      },
                    ),
                              ...
                              onPressed: () {
                                CustomDialog.showInfo(
                                    ...
                                    onPressed: () {
                                      ref
                                          .read(
                                              selectedStudentProvider.notifier)
