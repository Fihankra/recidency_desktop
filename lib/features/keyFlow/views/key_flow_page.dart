...
class _KeyFlowPageState extends ConsumerState<KeyFlowPage> {
  ...
  Widget build(BuildContext context) {
    var keyLogFuture = ref.watch(keyLogFutureProvider);
    ...
    return Container(
        ...
        child: Column(children: [
          ...
          Expanded(
              child: keyLogFuture.when(data: (data) {
            var keyLogData = ref.watch(keyLogProvider(data));
            var keyLogNotifier = ref.read(keyLogProvider(data).notifier);

            return CustomTable<KeyLogModel>(
                      ...
                      child: Row(children: [
                        ...
                        if (ref.watch(keyLogFilter) != 'All')
                          InkWell(
                            onTap: () {
                              keyLogNotifier.init();
                              ref.read(keyLogFilter.notifier).state = 'All';
                            },
                            child: Card(
                                child: Container(
                              width: 40,
                ...
                currentIndex: keyLogData.currentPageItems.isNotEmpty
                    ? data.indexOf(keyLogData.currentPageItems[0]) + 1
                    : 0,
            ...
            return  Center(child: Text('Something went wrong',style: tableTextStyle,));
          }, loading: () {
