...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  final _idController = TextEditingController(text: 'AH1234567890');
  final _passwordController = TextEditingController(text: '123456789');

  @override
  Widget build(BuildContext context) {
    var dbConnection = ref.watch(dbConnectionProvider);
    return Center(
        child: Card(
          elevation: 5,
                ...
                error: (error, stackTrace) => Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () {
                              var refresh = ref.refresh(dbConnectionProvider);
